...
public class sds : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (i == 1 && Input.GetKeyDown(KeyCode.Alpha3))
        {
    ...
    {
        Instantiate(obj2, obj1.transform.position = new Vector3(0, 1, 0), Quaternion.identity);
        DestroyImmediate(obj1, true);
    }
    void Replaced(GameObject obj1, GameObject obj3)
    {
        Instantiate(obj3, obj1.transform.position = new Vector3(250, 1, 0), Quaternion.identity);
        DestroyImmediate(obj1, true);
    }
}
